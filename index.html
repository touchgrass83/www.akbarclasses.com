...
<head>
    ...
    <link rel="icon" type="image/png" href="images/A.jpg"/>
    <title>AKBAR CLASSES</title>
</head>
<body>
    <header>
        <label for="menu-button">
            <input type="checkbox" id="menu-button" onclick="menuHandler()">
        ...
        <h2 id="tag-line">Think Logically</h2>

        <div class="search-bar">
            <label for="search-bar-input">
                <input type="text" id="search-bar-input" placeholder="Search" onclick="menuClose()">
            </label>
        ...
        <section class="section-body">
            <div class="logo">
                ...
                <div id="logo-box">
                    ...
                    <p id="sub-title">We teach our children to think logically</p>
                </div>
                <div id="shadow"></div>
            </div>
            ...
            <div class="page-body">
                ...
                <div class="selection-box">
                    ...
                    <a href="#3">
                        <div id="gallery">
                            <h2 id="gallery-title">GALLARY</h2>
                    ...
                    <a href="#5">
                        <div id="fee-structure">
                            <h2 id="fee-structure-title" id="fee-strucutre-icon">FEE STRUCTURE</h2>
                    ...
                    <a href="#6">
                        <div id="blogs">
                            ...
                            <p id="updates-description">Read insightful articles, tips, and educational guidance to help students and parents achieve academic success.</p>
                        </div>
                    </a>
                </div>
                <footer>
                    <div class="footer-container">
                        <div class="footer-about">
                          <h3>About Us</h3>
                          <p>At <strong>Akbar Classes</strong>, we are passionate about delivering high-quality solutions and resources to help you achieve your goals. Join our community and grow with us!</p>
                        </div>
